...
export const FriendList = () => {
    ...
    const loadFriends = async () => {
        try {
            ...
            for (var i = 0; i < response.data.length; i++) {
                ...
                const friendExist = flist.some(
                    (newFriend) => newFriend.Name === response.data[i].name
                );
    ...
    const deleteFriend = async (friendName: string) => {
        ...
        try {
            const response = await axios.delete(SERVER_URL + '/api/friends', {
                headers: {
                    authorization: token,
                },
                data: {
    ...
    return (
        <>
                        ...
                        >
                            {flist.map((value) => (
                                ...
                                >
                                    ...
                                    <ListItemText
                                        primary={`Name des Freundes: ${value.Name}`}
                                    />
                                </ListItem>
                            ))}
                        </List>
            ...
            >
                <DialogTitle id='alert-dialog-title'>{DiTi}</DialogTitle>
                <DialogContent>
