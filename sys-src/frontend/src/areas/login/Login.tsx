        ...
        <div style={{padding: 30, display:'flex', justifyContent: 'center', alignItems:'center'}}>
            <Paper style={{padding:50, background:'#d6e7d0'}}>
                ...
                alignItems={'center'}>
                    <h1>Login</h1>
                    <Grid item xs={12}>
                        <TextField label="Username" style={{background:'#bbd8b1'}}></TextField>
                    </Grid>
                    <Grid item xs={12}>
                        <TextField label="Password" style={{background:'#bbd8b1'}}></TextField>
                    </Grid>
                    <Grid item xs={12}>
                        <FormControlLabel
                            control={
                    ...
                    <Grid item xs={12}>
                        <Button fullWidth style={{background:'#bbd8b1', color:'black'}}>Login</Button>
                    </Grid>
                </Grid>
            </Paper>
        </div>
